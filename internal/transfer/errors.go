...
var (
	...
	ErrEmptySourceStorageProviderID      = errors.New("source storage provider id is empty")
	ErrEmptyDestinationStorageProviderID = errors.New("destination storage provider id is empty")
)
